...
ALLOWED_HOSTS = ['web-production-f10a.up.railway.app'] #asterisco indica que qualquer site é aceito. Usado temporariamente até ter o endereço correto.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'Site.templatetags.context_processors.departamentos',
            ],
        },
    },
]
...
DATABASES = {
     'default': {
         ...
         'HOST': 'https://containers-us-west-141.railway.app',
         'PORT': '6796',
     }
}
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'rafa.fernan10@gmail.com'
EMAIL_HOST_PASSWORD = 'gggztsdpezfozkbp'
